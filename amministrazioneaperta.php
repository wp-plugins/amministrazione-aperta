...
link utili a: progetto selezionato, curriculum del soggetto incaricato, contratto e capitolato della prestazione, fornitura o servizio',
        ...
        'show_in_menu' => true,
        'menu_position' => 5,
        'menu_icon' => site_url(). '/wp-content/plugins/AmministrazioneAperta/openshareicon-16x16.png',
...
function ammap_func( $atts ){
 include (ABSPATH. '/wp-content/plugins/AmministrazioneAperta/tablegen.php');
}
add_shortcode( 'ammap', 'ammap_func' );

/* =========== META BOX ============ */

include (ABSPATH. '/wp-content/plugins/AmministrazioneAperta/meta-box-class/my-meta-box-class.php');
/*
