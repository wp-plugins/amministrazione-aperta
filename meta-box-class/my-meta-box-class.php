...
/*
    ...
    echo "<div class='at-file-upload-label'> \n
      <strong>" . __( 'Carica un documento. [!] Verrà visualizzato il nome del documento caricato!','mmb' ) . "</strong>\n
    </div>\n";
    echo "<div class='new-files'>\n
      <div class='file-input'>\n
        <input type='file' name='{$field['id']}[]' />\n
      </div><!-- End .file-input -->\n
      <a class='at-add-file button' href='#'>" . __( 'Carica altri Allegati','mmb' ) . "</a>\n
      </div><!-- End .new-files -->\n";
    echo "</td>";
    $this->show_field_end( $field, $meta );
  }
