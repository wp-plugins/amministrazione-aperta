...
if ($incarico != 0) {
	if ($incarico == 1) {
		...
		if(!(has_term( 'Incarichi conferiti o autorizzati a dipendenti di altra Amministrazione', 'tipo_incarico' ))) { return; }
	} else if ($incarico == 3) {
		if(!(has_term( 'Incarichi conferiti o autorizzati a soggetti estranei alla Pubblica Amministrazione', 'tipo_incarico' ))) { return; }
	} else {
